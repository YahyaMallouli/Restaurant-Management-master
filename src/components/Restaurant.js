                            ...
                            <div className="card-body" >
                                ...
                                <form>
                                    ...
                                    <div className="row mb-3">
                                        ...
                                        <input type="datetime-local" className="form-control" id="user-password" value={dateOuverture} onChange={(e) => setdateopen(e.target.value)} />
                                    </div>
                                        <div className="col-md-6">
                                        <label htmlFor="restaurant-dateclose" className="form-label">date close:</label>
                                        <input type="datetime-local" className="form-control" id="user-password"   value={dateFermeture}
